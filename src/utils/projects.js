export const PROJECTS = [
    ...
    },
    {
        ...
        'image': 'robot',
        'link': 'https://channel4robotteam.github.io/index.html'
    },
    {
        'title': 'political bias detector',
        'description': 'a web app that when given a url to an online news article predicts the political bias of the source (from liberal to conservative). made use of natural language processing machine learning methods.',
        'skills': [
            'python',
            'nltk',
        ],
